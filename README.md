...
* [`src/umin/styles.cljs`](src/umin/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/umin/`](src/umin/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/umin/core.cljs): contains the SPA entry point, `init`
* [`test/umin/`](test/umin/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `umin` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/umin/config.cljs) defaults to `true` in
